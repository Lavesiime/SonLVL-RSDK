...
This editor is based on the original [SonLVL](https://github.com/sonicretro/SonLVL) tool, but adapted for the Retro Engine. Compatible with:
...
- _Sonic 1_ ([2013 mobile](https://info.sonicretro.org/Sonic_the_Hedgehog_(2013_game)) / [Origins](https://store.steampowered.com/app/1794960/Sonic_Origins/))
- _Sonic 2_ ([2013 mobile](https://info.sonicretro.org/Sonic_the_Hedgehog_2_(2013)) / [Origins](https://store.steampowered.com/app/1794960/Sonic_Origins/))
...
To set up the editor for the first time, refer to the [startup guide](https://lavesiime.github.io/guides/sonlvl/install/).
