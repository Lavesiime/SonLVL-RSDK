			...
			switch (Direction)
			{
				case Direction.Horizontal:
					...
					for (int c = stc; c < edc; c++)
						...
						{
							if (i == selectedIndex)
								g.DrawRectangle(new Pen(Color.Red, 3), (actualImageWidth * c) + 1 - hScrollBar1.Value, actualImageHeight * r + 1, actualImageWidth - 2, actualImageHeight - 2);
				...
				case Direction.Vertical:
					...
					for (int r = str; r < edr; r++)
						...
						{
							if (i == selectedIndex)
								g.DrawRectangle(new Pen(Color.Red, 3), actualImageWidth * c + 1, (actualImageHeight * r) - vScrollBar1.Value + 1, actualImageWidth - 2, actualImageHeight - 2);
