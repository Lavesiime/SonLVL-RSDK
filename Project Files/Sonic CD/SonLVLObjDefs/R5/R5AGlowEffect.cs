...
{
	public class R5AGlowEffect : DefaultObjectDefinition
	{
		public override void Init(ObjectData data)
		{
			...
			// In-game, the object attempts to load 5 lines, but only uses the first 4 anyways
			// The file only contains 4 lines in the first place, so..
			LevelData.AddPaletteCycle("Glowing Rocks", "R5A_GlowEffect.act", 176, 16, 4);
