...
{
	public class SpecialSetup : DefaultObjectDefinition
	{
		public override void Init(ObjectData data)
		{
			...
			// Technically the file has 256 colours or so in all, but..
			// Only the first 12 sets are used, there's no reason to show all the FF00FF sets ofc
			LevelData.AddPaletteCycle("Stage Colors", "SpecialStage.act", 192, 8, 12);
